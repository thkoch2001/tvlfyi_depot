    ...
    depot.users.Profpatsch.writers.python3
      {
        ...
        libraries = p: [ depot.users.Profpatsch.netstring.python-netstring ];
      }
      ''
        import netstring
        ...
        assEq(
          netstring.read_netstring_key_val_list(
            b"""${
              depot.nix.netstring.attrsToKeyValList {
                foo = "42";
                bar = "hi";
              }
            }"""
    ...
    depot.nix.writers.rustSimple
      {
        ...
        dependencies = [ depot.users.Profpatsch.netstring.rust-netstring ];
      }
      ''
