...
let
  python-netstring-test =
    depot.users.Profpatsch.writers.python3
      { name = "python-netstring-test"; libraries = p: [ depot.users.Profpatsch.netstring.python-netstring ]; }
      ''
      import netstring
  ...
  rust-netstring-test =
    depot.nix.writers.rustSimple
      { name = "rust-netstring-test"; dependencies = [ depot.users.Profpatsch.netstring.rust-netstring ]; }
      ''
      ...
      '';
in
depot.nix.readTree.drvTargets { inherit python-netstring-test rust-netstring-test; }
