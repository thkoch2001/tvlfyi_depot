        ...
        this.state = {
            ...
            budget: [
                { 
                    label: 'Flexible', 
                    children: [
                        { label: 'groceries', monthly: 400.00 },
                        { label: 'eating out', monthly: 100.00 },
                        { label: 'alcohol', monthly: 100.00 },
                        { label: 'household items', monthly: 100.00 },
                        { label: 'toiletries', monthly: 100.00 },
                        { label: 'haircuts', monthly: 100.00 },
                        { label: 'gasoline', monthly: 100.00 },
                        { label: 'parking', monthly: 100.00 },
                        { label: 'ride services', monthly: 100.00 },
                        { label: 'LMNT', monthly: 100.00 },
                        { label: 'books', monthly: 100.00 },
                        { label: 'vacation', monthly: 100.00 },
                        { label: 'reimbursement', monthly: 100.00 },
                    ],
                },
                { 
                    label: 'Flexible', 
                    children: [
                        { label: 'rent', monthly: 100.00 },
                        { label: 'electric', monthly: 100.00 },
                        { label: 'gas', monthly: 100.00 },
                        { label: 'YNAB', monthly: 100.00 },
                        { label: 'Robinhood Gold', monthly: 100.00 },
                        { label: 'Spotify', monthly: 100.00 },
                        { label: 'Surfline', monthly: 100.00 },
                        { label: 'HBO Max', monthly: 100.00 },
                        { label: 'Clear', monthly: 100.00 },
                        { label: 'car insurance', monthly: 100.00 },
                        { label: 'Making Sense', monthly: 100.00 },
                        { label: 'internet', monthly: 100.00 },
                        { label: 'tax return', monthly: 100.00 },
                    ],
                },
                {
                    label: 'Rainy Day (dont touch)',
                    children: [
                        { label: 'emergency fund', monthly: 100.00 },
                        { label: 'check-ups', monthly: 100.00 },
                        { label: 'car maintenance', monthly: 100.00 },
                    ],
                },
                {
                    label: 'Savings (dont touch)',
                    children: [
                        { label: 'stocks', monthly: 100.00 },
                        { label: 'crypto', monthly: 100.00 },
                    ],
                },
                {
                    label: 'Gifts (dont touch)',
                    children: [
                        { label: 'birthdays', monthly: 100.00 },
                        { label: 'Valentines Day', monthly: 100.00 },
                        { label: 'Mothers Day', monthly: 100.00 },
                        { label: 'Fathers Day', monthly: 100.00 },
                        { label: 'Christmas', monthly: 100.00 },
                    ],
                },
                {
                    label: 'Error Budget',
                    children: [
                        { label: 'stuff I forgot to budget for', monthly: 100.00 },
                    ],
                },
            ],
            paycheck: 6800.00,
