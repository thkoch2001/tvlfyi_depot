...
in
{
  ...
  files =
    dir: map ( name: dir + "/${ name }" ) ( attrNames ( filterAttrs ( _: type: type == "regular" ) ( readDir dir ) ) );
  ...
  resolve =
    ...
    then
      ...
      # stack overflowing.
      if ( dirOf dir ) == dir then null else resolve name ( dirOf dir );
}
;}
