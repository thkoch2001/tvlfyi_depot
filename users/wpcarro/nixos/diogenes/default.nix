...
wpcarro.terraform.googleCloudVM
  {
    ...
    extraConfig = {
      ...
      resource.google_dns_managed_zone."${ name }" = { inherit name; dns_name = "${ domainName }."; };
      ...
      resource.google_compute_instance."${ name }" = { network_interface.access_config = { public_ptr_domain_name = "${ domainName }."; }; };
      # monsterpoker.app
      resource.google_dns_managed_zone."monsterpoker" = { name = "monsterpoker"; dns_name = "monsterpoker.app."; };
    ...
    configuration = {
      imports = [ "${ depot.path }/ops/modules/quassel.nix" ];
      networking = {
      ...
      users = {
        mutableUsers = true;
        users = {
          root = { openssh.authorizedKeys.keys = wpcarro.keys.all; };
          wpcarro = {
            isNormalUser = true;
      ...
      security = { acme = { acceptTerms = true; defaults.email = "wpcarro@gmail.com"; }; sudo.wheelNeedsPassword = false; };
      programs = wpcarro.common.programs // { mosh.enable = true; };
      ...
      services =
        wpcarro.common.services
          // {
            ...
            depot.quassel = { enable = true; acmeHost = domainName; bindAddresses = [ "0.0.0.0" ]; };
            journaldriver = {
              enable = true;
              logStream = "home";
            ...
            nginx = {
              ...
              commonHttpConfig =
                ...
                '';
              virtualHosts = {
                "${ domainName }" = { addSSL = true; enableACME = true; root = wpcarro.website.root; };
                "monsterpoker.app" = { addSSL = true; enableACME = true; root = wpcarro.clients.monsterpoker; };
              };
            };
          };
