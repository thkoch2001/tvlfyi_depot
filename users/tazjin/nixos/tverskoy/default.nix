...
config:
let
  quasselClient = pkgs.quassel.override { client = true; enableDaemon = false; monolithic = false; };
...
lib.fix
  (
    self:
    {
      imports = [ "${ depot.third_party.impermanence }/nixos.nix" "${ pkgs.home-manager.src }/nixos" ];
      ...
      fileSystems = {
        "/" = { device = "tmpfs"; fsType = "tmpfs"; options = [ "defaults" "size=8G" "mode=755" ]; };
        "/home" = { device = "zpool/ephemeral/home"; fsType = "zfs"; };
        "/nix" = { device = "zpool/local/nix"; fsType = "zfs"; };
        "/depot" = { device = "zpool/safe/depot"; fsType = "zfs"; };
        "/persist" = { device = "zpool/safe/persist"; fsType = "zfs"; neededForBoot = true; };
        # SD card
        "/mnt" = { device = "/dev/disk/by-uuid/c602d703-f1b9-4a44-9e45-94dfe24bdaa8"; fsType = "ext4"; };
        "/boot" = { device = "/dev/disk/by-uuid/BF4F-388B"; fsType = "vfat"; };
      };
      hardware = {
        cpu.amd.updateMicrocode = true;
        enableRedistributableFirmware = true;
        bluetooth.enable = true;
        opengl = { enable = true; extraPackages = with pkgs; [ vaapiVdpau libvdpau-va-gl ]; };
      };
      networking = {
        hostName = "tverskoy";
        hostId = "3c91827f";
      ...
      fonts = {
        fonts = with pkgs; [ corefonts dejavu_fonts jetbrains-mono noto-fonts-cjk noto-fonts-emoji ];
        fontconfig = {
          hinting.enable = true;
      ...
      services = {
        ...
        tlp = { enable = true; settings.START_CHARGE_THRESH_BAT0 = 40; settings.STOP_CHARGE_THRESH_BAT0 = 70; };
        xserver = {
          enable = true;
          layout = "us";
          ...
          windowManager.session =
            lib.singleton { name = "exwm"; start = "${ depot.users.tazjin.emacs }/bin/tazjins-emacs"; };
        };
      ...
      environment.sessionVariables = { XMODIFIERS = "@im=exwm-xim"; GTK_IM_MODULE = "xim"; QT_IM_MODULE = "xim"; CLUTTER_IM_MODULE = "xim"; };
      ...
      users.users.tazjin = {
        ...
        initialHashedPassword =
          "$6$d3FywUNCuZnJ4l.$ZW2ul59MLYon1v1xhC3lTJZfZ91lWW6Tpi13MpME0cJcYZNrsx7ABdgQRn.K05awruG2Y9ARAzURnmiJ31WTS1";
      };
      programs = {
        adb.enable = true;
        fish.enable = true;
      ...
      environment.systemPackages =
        ...
        ( with depot; [ screenLock tools.nsfv-setup users.tazjin.emacs third_party.agenix.cli third_party.dfmt ] )
          ++
      ...
      systemd.user.services.lieer-tazjin = {
        ...
        serviceConfig = { WorkingDirectory = "%h/mail/account.tazjin"; Type = "oneshot"; };
      };
      systemd.user.timers.lieer-tazjin = { wantedBy = [ "timers.target" ]; timerConfig = { OnActiveSec = "1"; OnUnitActiveSec = "180"; }; };
      home-manager.useGlobalPkgs = true;
      home-manager.users.tazjin =
        { config
        , lib
        , ...
        }:
        {
          ...
          programs.git = {
            ...
            extraConfig = { pull.rebase = true; init.defaultBranch = "canon"; };
          };
          programs.fish = {
            enable = true;
          ...
          services.picom = { enable = true; vSync = true; backend = "glx"; };
