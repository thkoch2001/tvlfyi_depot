...
lib.fix
  (
    self:
    {
      imports = [ "${ depot.path }/ops/modules/v4l2loopback.nix" ];
      boot = {
        tmpOnTmpfs = true;
      ...
      users.extraUsers.tazjin = { extraGroups = [ "wheel" "audio" "docker" ]; isNormalUser = true; uid = 1000; shell = pkgs.fish; };
      security.sudo = { enable = true; extraConfig = "wheel ALL=(ALL:ALL) SETENV: ALL"; };
      fonts = {
      ...
      location = { latitude = 51.4819109; longitude = -0.1252998; };
