    ...
    defun
      ...
      (
        e:
        {
          ...
          links = singleton { rel = "alternate"; href = e.url; };
        }
      );
  allEntries =
    ( with depot.users.tazjin.blog; map ( blog.toFeedEntry config ) posts ) ++ ( map pageEntryToEntry pageEntries );
  feed = {
    id = "https://tazj.in/";
    ...
    rights = "© 2020 tazjin";
    authors = [ "tazjin" ];
    links = singleton { rel = "self"; href = "https://tazjin/feed.atom"; };
    entries = allEntries;
  };
in
