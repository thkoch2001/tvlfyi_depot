...
let
  ...
  */
  # TODO(sterni): test if tailCallOpt makes anything faster (doubt)
  # TODO(sterni): investigate strict variant for even deeper recursion
  tailCallOpt = f:
    let
