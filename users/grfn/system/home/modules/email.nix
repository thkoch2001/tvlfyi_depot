...
let
  ...
  accounts = {
    personal = { primary = true; address = "root@gws.fyi"; aliases = [ "grfn@gws.fyi" ]; passEntry = "root-gws-msmtp"; };
    work = { address = "griffin@readyset.io"; passEntry = "readyset/msmtp"; };
  };
in
{
  ...
  home.packages = with pkgs; [ mu msmtp ];
    ...
    mapAttrs
      (
        ...
        }:
        {
          ...
          flavor = "gmail.com";
          imapnotify = { enable = true; boxes = [ "Inbox" ]; };
          gpg = { key = "0F11A989879E8BBBFDC1E23644EF5B5E861C09A7"; signByDefault = true; };
          notmuch.enable = true;
          lieer = { enable = true; sync = { enable = true; frequency = "*:*"; }; };
          msmtp.enable = true;
        }
