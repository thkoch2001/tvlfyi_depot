...
in
{
  options =
    with lib;
    {
      system.machine.wirelessInterface =
        mkOption
          {
            description =
              ''
      ...
      system.machine.i3FontSize =
        mkOption { description = "Font size to use in i3 window decorations etc."; default = 6; type = types.int; };
    };
  config =
    let
      ...
      xsession.windowManager.i3 = {
        ...
        config = {
          ...
          colors =
            ...
            rec
              {
              focused = { border = base01; background = base01; text = base3; indicator = red; childBorder = base02; };
              focusedInactive =
                focused
                  // {
                    border = base03;
          ...
          bars = [
            {
              ...
              colors =
                ...
                rec
                  ...
                  statusline = base3;
                  separator = base1;
                  activeWorkspace = { border = base03; background = base1; text = base3; };
      ...
      services.dunst = {
        ...
        settings =
          with solarized;
          {
            ...
            frame = { width = 0; color = "#aaaaaa"; };
            urgency_low = { background = base03; foreground = base3; timeout = 5; };
            urgency_normal = { background = base02; foreground = base3; timeout = 7; };
            urgency_critical = { background = red; foreground = base3; timeout = 0; };
          };
      };
      gtk = { enable = true; iconTheme.name = "Adwaita"; theme.name = "Adwaita"; };
    };
}
