                    ...
                    submodule
                      {
                        options = {
                          url =
                            mkOption { type = nullOr str; description = "URL of repository to clone"; default = null; };
                          github =
                            mkOption
                              {
                                type = nullOr str;
                          ...
                          path = mkOption { type = str; description = "Path to clone to"; };
                          onClone =
                            mkOption
                              {
                                type = str;
    ...
    home.activation =
      mapAttrs
        (
          ...
          let
            repoURL = if isNull url then "git@github.com:${ github }" else url;
          in
          hm.dag.entryAfter
            ( [ "writeBoundary" ] ++ after )
            ''
