...
with lib;
{
  ...
  programs.git = {
    ...
    ignores = [ "*.sw*" ".classpath" ".project" ".settings/" ".dir-locals.el" ".stack-work-profiling" ".projectile" ];
    extraConfig = {
    ...
    delta = {
      enable = true;
      options = { syntax-theme = "Solarized (light)"; hunk-style = "plain"; commit-style = "box"; };
    };
  };
