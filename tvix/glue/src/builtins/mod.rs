...
pub use import_error::Error as ImportError;
...
mod tests {
    ...
    #[test_case(r#"(builtins.filterSource (p: t: true) ./src/tests/import_fixtures)"#, "/nix/store/bqh6kd0x3vps2rzagzpl7qmbbgnx19cp-import_fixtures"; "complicated directory: filter nothing")]
    ...
    #[test_case(r#"builtins.filterSource (p: t: t != "directory") ./src/tests/import_fixtures/c_dir"#, "/nix/store/riigfmmzzrq65zqiffcjk5sbqr9c9h09-c_dir"; "simple directory with one symlink to a file: filter directory")]
    #[test_case(r#"builtins.filterSource (p: t: t != "regular") ./src/tests/import_fixtures/c_dir"#, "/nix/store/riigfmmzzrq65zqiffcjk5sbqr9c9h09-c_dir"; "simple directory with one symlink to a file: filter files")]
    ...
    #[test_case(r#"builtins.filterSource (p: t: true) ./src/tests/import_fixtures/c_dir"#, "/nix/store/riigfmmzzrq65zqiffcjk5sbqr9c9h09-c_dir"; "simple directory with one symlink to a file: filter nothing")]
    ...
    #[test_case(r#"builtins.filterSource (p: t: t != "directory") ./src/tests/import_fixtures/d_dir"#, "/nix/store/f2d1aixwiqy4lbzrd040ala2s4m2z199-d_dir"; "simple directory with dangling symlink: filter directory")]
    #[test_case(r#"builtins.filterSource (p: t: t != "regular") ./src/tests/import_fixtures/d_dir"#, "/nix/store/f2d1aixwiqy4lbzrd040ala2s4m2z199-d_dir"; "simple directory with dangling symlink: filter file")]
    #[test_case(r#"builtins.filterSource (p: t: t != "symlink") ./src/tests/import_fixtures/d_dir"#, "/nix/store/7l371xax8kknhpska4wrmyll1mzlhzvl-d_dir"; "simple directory with dangling symlink: filter symlinks")]
    #[test_case(r#"builtins.filterSource (p: t: true) ./src/tests/import_fixtures/d_dir"#, "/nix/store/f2d1aixwiqy4lbzrd040ala2s4m2z199-d_dir"; "simple directory with dangling symlink: filter nothing")]
    #[test_case(r#"builtins.filterSource (p: t: false) ./src/tests/import_fixtures/d_dir"#, "/nix/store/7l371xax8kknhpska4wrmyll1mzlhzvl-d_dir"; "simple directory with dangling symlink: filter everything")]
    #[test_case(r#"builtins.filterSource (p: t: t != "directory") ./src/tests/import_fixtures/symlink_to_a_dir"#, "/nix/store/apmdprm8fwl2zrjpbyfcd99zrnhvf47q-symlink_to_a_dir"; "simple symlinked directory with one file: filter directories")]
    #[test_case(r#"builtins.filterSource (p: t: t != "regular") ./src/tests/import_fixtures/symlink_to_a_dir"#, "/nix/store/apmdprm8fwl2zrjpbyfcd99zrnhvf47q-symlink_to_a_dir"; "simple symlinked directory with one file: filter file")]
    #[test_case(r#"builtins.filterSource (p: t: t != "symlink") ./src/tests/import_fixtures/symlink_to_a_dir"#, "/nix/store/apmdprm8fwl2zrjpbyfcd99zrnhvf47q-symlink_to_a_dir"; "simple symlinked directory with one file: filter symlinks")]
    #[test_case(r#"builtins.filterSource (p: t: true) ./src/tests/import_fixtures/symlink_to_a_dir"#, "/nix/store/apmdprm8fwl2zrjpbyfcd99zrnhvf47q-symlink_to_a_dir"; "simple symlinked directory with one file: filter nothing")]
    #[test_case(r#"builtins.filterSource (p: t: false) ./src/tests/import_fixtures/symlink_to_a_dir"#, "/nix/store/apmdprm8fwl2zrjpbyfcd99zrnhvf47q-symlink_to_a_dir"; "simple symlinked directory with one file: filter everything")]
    ...
    // after the filtering.
    #[test_case(r#"(builtins.filterSource (p: t: t == "unknown") @target)"#, false; "complicated directory: filter unsupported types")]
    #[test_case(r#"(builtins.filterSource (p: t: (builtins.baseNameOf p) != "a_charnode") @target)"#, false; "complicated directory: filter character device nodes")]
    #[test_case(r#"(builtins.filterSource (p: t: (builtins.baseNameOf p) != "a_socket") @target)"#, false; "complicated directory: filter sockets")]
    #[test_case(r#"(builtins.filterSource (p: t: (builtins.baseNameOf p) != "a_fifo") @target)"#, false; "complicated directory: filter FIFOs")]
    // We filter all invalid filetypes, so the evaluation has to succeed.
    #[test_case(r#"(builtins.filterSource (p: t: t != "unknown") @target)"#, true; "complicated directory: filter out unsupported types")]
