  ...
  internal = rec {
    ...
    crates = {
      ...
      "polars" = rec {
        ...
        resolvedDefaultFeatures = [ "csv" "default" "docs" "dtype-date" "dtype-datetime" "dtype-duration" "dtype-slim" "fmt" "ipc" "polars-io" "polars-ops" "polars-time" "temporal" "zip_with" ];
      };
      "polars-arrow" = rec {
      ...
      "polars-io" = rec {
        ...
        resolvedDefaultFeatures = [ "atoi_simd" "chrono" "csv" "dtype-date" "dtype-datetime" "dtype-time" "fast-float" "ipc" "itoa" "lazy" "polars-time" "ryu" "simdutf8" "temporal" ];
      };
      "polars-lazy" = rec {
        ...
        resolvedDefaultFeatures = [ "abs" "cross_join" "csv" "cum_agg" "dtype-date" "dtype-datetime" "dtype-duration" "dtype-i16" "dtype-i8" "dtype-time" "ipc" "is_in" "log" "meta" "polars-time" "regex" "round_series" "strings" "temporal" "trigonometry" ];
      };
      "polars-ops" = rec {
      ...
      "polars-pipe" = rec {
        ...
        resolvedDefaultFeatures = [ "cross_join" "csv" "dtype-i16" "dtype-i8" "ipc" ];
      };
      "polars-plan" = rec {
      ...
      "polars-sql" = rec {
        ...
        resolvedDefaultFeatures = [ "csv" "ipc" ];
      };
      "polars-time" = rec {
