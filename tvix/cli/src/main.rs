        ...
        .block_on(tokio::spawn({
            ...
            async move {
                ...
                let directory_service =
                    directoryservice::from_addr(&directory_service_addr).await?;
                ...
                Ok::<_, std::io::Error>((blob_service, directory_service, path_info_service))
            }
        }))
        .unwrap()
        .expect("failed to setup stores");
