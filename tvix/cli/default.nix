...
(depot.tvix.crates.workspaceMembers.tvix-cli.build.override {
  ...
  meta = {
    ci.extraSteps = {
      ...
      eval-nixpkgs-cross-gcc-drvpath = (mkNixpkgsEvalCheck "pkgsCross.aarch64-multiplatform.buildPackages.gcc.drvPath" pkgs.pkgsCross.aarch64-multiplatform.buildPackages.gcc.drvPath);
