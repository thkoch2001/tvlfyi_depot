          ...
          pkgsCrossWasm32 = (import
            (pkgs.applyPatches {
              ...
              patches = [
                ...
                ./temp-patches/0001-buildRustCrate-use-buildPlatform-s-library-extension.patch
              ];
            })
            { }).pkgsCross.wasm32-unknown-none;
        in
        {
          inherit ((pkgsCrossWasm32.callPackage ./Cargo.nix {
            defaultCrateOverrides = defaultCrateOverridesForPkgs pkgsCrossWasm32;
