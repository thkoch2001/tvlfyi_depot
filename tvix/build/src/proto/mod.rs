...
impl TryFrom<BuildRequest> for crate::buildservice::BuildRequest {
    ...
    fn try_from(value: BuildRequest) -> Result<Self, Self::Error> {
        ...
        let mut last_name: bytes::Bytes = "".into();
        let mut inputs: Vec<tvix_castore::Node> = vec![];
...
impl From<crate::buildservice::BuildConstraints> for build_request::BuildConstraints {
    fn from(value: crate::buildservice::BuildConstraints) -> Self {
        Self {
            system: value.system,
            min_memory: value.min_memory,
            available_ro_paths: value.available_ro_paths,
            network_access: value.network_access,
            provide_bin_sh: value.provide_bin_sh,
        }
    }
}

impl TryFrom<build_request::BuildConstraints> for crate::buildservice::BuildConstraints {
