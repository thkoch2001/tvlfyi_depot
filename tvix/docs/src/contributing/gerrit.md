...
[^keycloak]: Note that our IdP (Keycloak) sometimes has
	[problems doing SSO with GitHub](https://b.tvl.fyi/issues/201), so you
	might get an “unexpected error” while trying to sign in with GitHub.
	It’s not your fault.
