...
lazy_static! {
    ...
    // Directories
    pub static ref DIRECTORY_WITH_KEEP: Directory = Directory::from_iter([(
    ...
    pub static ref DIRECTORY_COMPLICATED: Directory = Directory::from_iter([
        (
            "keep".try_into().unwrap(),
            Node::Directory{
    ...
    pub static ref DIRECTORY_B: Directory = Directory::from_iter([(
            "a".try_into().unwrap(),
            Node::Directory{
    ...
    pub static ref DIRECTORY_C: Directory = Directory::from_iter([
        (
            "a".try_into().unwrap(),
            Node::Directory{
                digest: DIRECTORY_A.digest(),
    ...
    pub static ref DIRECTORY_D: Directory = Directory::from_iter([
        (
            "a".try_into().unwrap(),
            Node::Directory{
                digest: DIRECTORY_A.digest(),
