...
fn validate_invalid_names() {
    {
        ...
        match crate::Directory::try_from(d).expect_err("must fail") {
            DirectoryError::InvalidName(PathComponentError::NullBytes) => {}
...

    {
        ...
        match crate::Directory::try_from(d).expect_err("must fail") {
            DirectoryError::InvalidName(PathComponentError::Dot) => {}
            _ => panic!("unexpected error"),
        };
    }

    {
        ...
        match crate::Directory::try_from(d).expect_err("must fail") {
            DirectoryError::InvalidName(PathComponentError::DotDot) => {}
            _ => panic!("unexpected error"),
        };
    }
