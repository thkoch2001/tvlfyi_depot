...
mod tests {
    ...
    #[test_case("grpc+inetd:doesnotexist?wait-connect=0", true; "grpc invalid command wait-connect=0")]
    /// Connecting with wait-connect set to 1 and a non-existent binary fails.
    #[test_case("grpc+inetd:doesnotexist?wait-connect=1", false; "grpc invalid command wait-connect=1 fails")]
    #[tokio::test]
