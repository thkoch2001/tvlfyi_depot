...
impl ClosureValidator {
    ...
    pub(crate) fn finalize(self) -> Result<Vec<Directory>, Error> {
        ...
        // do a DFS PostOrder traversal of the graph, starting with the root node.
        let mut traversal = DfsPostOrder::new(&self.graph, last_directory_ix);
