...
use crate::{
    ...
    proto::directory_service_client::DirectoryServiceClient, Error,
};
...
mod tests {
    ...
    /// An valid example for Bigtable, specifying a custom channel size and timeout
    #[cfg_attr(
        feature = "cloud",
        case::bigtable_valid_url(
    ...
    /// An invalid Bigtable example (missing fields)
    #[cfg_attr(
        feature = "cloud",
