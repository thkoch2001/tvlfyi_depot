...
pub(crate) fn register_directory_services(reg: &mut Registry) {
    ...
    reg.register::<Box<dyn ServiceBuilder<Output = Arc<dyn DirectoryService>>>, super::directoryservice::GRPCDirectoryServiceConfig>("grpc");
    #[cfg(feature = "cloud")]
    {
        reg.register::<Box<dyn ServiceBuilder<Output = Arc<dyn DirectoryService>>>, super::directoryservice::BigtableParameters>("bigtable");
    }
}
