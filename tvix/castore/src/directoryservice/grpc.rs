...
mod tests {
    ...
    use crate::{
        directoryservice::{
            grpc::GRPCPutter, DirectoryService, GRPCDirectoryService, MemoryDirectoryService,
        },
    ...
    async fn test() {
        ...
        // Uploading anything else subsequently should then fail.
        {
            ...
            let mut handle: Box<GRPCPutter> = handle.downcast_mut().expect("must be GRPCPutter");
