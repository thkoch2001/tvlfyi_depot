...
pub fn directory_services(#[case] directory_service: Box<dyn DirectoryService>) {}

/// Ensures asking for a directory that doesn't exist returns a Ok(None).
#[apply(directory_services)]
#[tokio::test]
async fn test_non_exist(directory_service: Box<dyn DirectoryService>) {
...
#[apply(directory_services)]
#[tokio::test]
async fn put_get(directory_service: Box<dyn DirectoryService>) {
    // Insert a Directory.
...
#[apply(directory_services)]
#[tokio::test]
async fn put_get_multiple_success(directory_service: Box<dyn DirectoryService>) {
...
#[apply(directory_services)]
#[tokio::test]
async fn put_get_multiple_dedup(directory_service: Box<dyn DirectoryService>) {
    // Insert a Directory closure.
    let mut handle = directory_service.put_multiple_start();
    handle.put(DIRECTORY_A.clone()).await.unwrap();
    handle.put(DIRECTORY_A.clone()).await.unwrap();
...
#[apply(directory_services)]
#[tokio::test]
async fn upload_reject_unconnected(directory_service: Box<dyn DirectoryService>) {
    let mut handle = directory_service.put_multiple_start();
...
#[apply(directory_services)]
#[tokio::test]
async fn upload_reject_dangling_pointer(directory_service: Box<dyn DirectoryService>) {
    let mut handle = directory_service.put_multiple_start();
...
#[apply(directory_services)]
#[tokio::test]
async fn upload_reject_failing_validation(directory_service: Box<dyn DirectoryService>) {
...
#[apply(directory_services)]
#[tokio::test]
async fn upload_reject_wrong_size(directory_service: Box<dyn DirectoryService>) {
