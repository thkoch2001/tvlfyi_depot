...
pub struct TracingBuilder {
    ...
    additional_layers: Vec<Box<dyn Layer<Registry> + Send + Sync>>,
}

// pub struct TracingBuilderWithLayers<T> {
//     layered: Layered<>
// }
...
impl TracingBuilder {
    ...
    pub fn with_layer<L>(mut self, layer: L) -> TracingBuilder
    where
        L: Layer<Registry> + Send + Sync + 'static,
    {
        self.additional_layers.push(Box::new(layer));
        self
    }
