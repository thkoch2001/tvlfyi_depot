...
///
/// A NAR can be thought of as a tree of files, where the root of the tree and
/// all of its children (such as directories or the files contained therein) are
/// nodes represented by this type.
...
impl<'a, 'w> Node<'a, 'w> {
    ...
    /// Fill the node with a single file.
    ...
    /// Fill the node with a directory, the content of which is set using the
...
impl<'a, 'w> Directory<'a, 'w> {
    ...
    // TODO: panic in Directory::drop if this was not called?
