...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match cli.command {
        ...
        Commands::Copy {
            ...
            let reference_graph_json = tokio::fs::read_to_string(&reference_graph_path).await?;
            ...
            let reference_graph: ReferenceGraph<'_> = serde_json::from_str(&reference_graph_json)?;
