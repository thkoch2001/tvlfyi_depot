...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // initialize stores
    let mut blob_service = MemoryBlobService::new();
    let mut chunk_service = MemoryChunkService::new();
    let mut directory_service = MemoryDirectoryService::new();
