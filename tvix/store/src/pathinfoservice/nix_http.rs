...
impl PathInfoService for NixHTTPPathInfoService {
    #[instrument(skip(self), fields(path.digest=BASE64.encode(&digest)))]
    async fn get(&self, digest: [u8; 20]) -> Result<Option<PathInfo>, Error> {
        ...
        info!(narinfo_url= %narinfo_url, "constructed NARInfo url");
        ...
        info!(nar_url= %nar_url, "constructed NAR url");
    ...
    #[instrument(skip(self), fields(path_info=?_path_info))]
    ...
    #[instrument(skip(self), fields(root_node=?root_node))]
