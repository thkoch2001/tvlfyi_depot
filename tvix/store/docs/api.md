...
3. Stores may communicate with other stores, to substitute already built store
...
Most of the hashing / upload can happen in parallel, as long as the list of
child files, symlinks and directories stays alphabetically sorted.
