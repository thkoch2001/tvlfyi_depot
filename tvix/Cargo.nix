  ...
  internal = rec {
    ...
    crates = {
      ...
      "object_store" = rec {
        ...
        version = "0.9.0";
        edition = "2021";
        sha256 = "00002gqndic69qxx2wpbxl0sp2088wfgincgd3iy4c26yr2zaffi";
        dependencies = [
          {
            name = "async-trait";
            packageId = "async-trait";
        ...
        resolvedDefaultFeatures = [ "aws" "azure" "base64" "cloud" "gcp" "http" "hyper" "quick-xml" "rand" "reqwest" "ring" "rustls-pemfile" "serde" "serde_json" ];
      };
      "once_cell" = rec {
        crateName = "once_cell";
        version = "1.19.0";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__tls" "hyper-rustls" "json" "rustls" "rustls-native-certs" "rustls-pemfile" "rustls-tls" "rustls-tls-native-roots" "rustls-tls-webpki-roots" "serde_json" "stream" "tokio-rustls" "tokio-util" "wasm-streams" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.17.7";
