    ...
    crates = {
      ...
      "nar-bridge" = rec {
        ...
        src =
          ...
          then lib.cleanSourceWith { filter = sourceFilter; src = ./nar-bridge; }
          else ./nar-bridge;
        dependencies = [
          {
            name = "axum";
      ...
      "reqwest 0.12.5" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-ring" "__tls" "rustls-tls-native-roots" "stream" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.17.7";
      ...
      "tokio-listener" = rec {
        ...
        resolvedDefaultFeatures = [ "axum07" "clap" "default" "inetd" "multi-listener" "nix" "sd_listen" "socket2" "socket_options" "tokio-util" "tonic011" "unix" "unix_path_tools" "user_facing_default" ];
      };
      "tokio-macros" = rec {
      ...
      "tvix-store" = rec {
        ...
        crateBin = [
          {
            name = "tvix-cache-daemon";
            path = "src/bin/tvix-cache-daemon.rs";
            requiredFeatures = [ ];
          }
          {
            name = "tvix-store";
