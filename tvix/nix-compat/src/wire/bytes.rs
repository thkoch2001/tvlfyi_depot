    ...
    S: RangeBounds<u64>,
{
    ...
    if len > usize::MAX as u64 {
        return Err(std::io::Error::new(
            std::io::ErrorKind::InvalidData,
            "length overflows usize. Not implemented yet",
        ));
    }
...
///
/// The len input is exspressed as a u64 because it's sometimes
/// provided by the Nix client as a u64. It'd be unsafe to convert it
/// to usize. For the output, we're sure it won't ever exceepd u64:
/// it's a 8-modulo.
