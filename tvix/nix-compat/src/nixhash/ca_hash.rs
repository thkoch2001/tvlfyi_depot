...
impl CAHash {
    #[must_use] pub fn hash(&self) -> Cow<NixHash> {
        match *self {
    ...
    #[must_use] pub fn mode(&self) -> HashMode {
        match self {
    ...
    #[must_use] pub fn algo_str(&self) -> &'static str {
        match self.mode() {
    ...
    #[must_use] pub fn to_nix_nixbase32_string(&self) -> String {
        format!(
            "{}:{}",
            self.algo_str(),
