...
impl NixHash {
    ...
    #[must_use] pub fn algo(&self) -> HashAlgo {
        match self {
    ...
    #[must_use] pub fn digest_as_bytes(&self) -> &[u8] {
        match self {
    ...
    #[must_use] pub fn to_nix_hex_string(&self) -> String {
    ...
    #[must_use] pub fn to_plain_hex_string(&self) -> String {
