...
pub enum BuildStorePathError {
    #[error("Store Path name is Invalid")]
    InvalidName(Error),
    #[error("References were not supported as much as requtested")]
    InvalidReference(),
}
...
/// This builds a more regular non-CA PATH
            ...
            build_store_path_from_fingerprint_parts(
                ...
                &{
                    let content_digest = {
                        ...
                        hasher.update(hash_with_mode.digest().algo.as_str());
                        hasher.update(":");
                        hasher.update(
...
/// This builds an input-addressed derivation output path
