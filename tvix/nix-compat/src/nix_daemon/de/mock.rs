...
impl Error {
    #[must_use]
    pub const fn expected_read_number() -> Self {
        Self::WrongRead(OperationType::ReadNumber, OperationType::ReadBytes)
    }

    #[must_use]
    pub const fn expected_read_bytes() -> Self {
        Self::WrongRead(OperationType::ReadBytes, OperationType::ReadNumber)
    }
}
...
impl From<Operation> for OperationType {
    fn from(value: Operation) -> Self {
        match value {
            Operation::ReadNumber(_) => Self::ReadNumber,
            Operation::ReadBytes(_) => Self::ReadBytes,
        }
    }
}
