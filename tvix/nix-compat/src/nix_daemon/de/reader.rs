    ...
    R: AsyncReadExt + Send + Unpin,
{
    ...
    fn try_read_number(
        &mut self,
    ) -> impl std::future::Future<Output = Result<Option<u64>, Self::Error>> + Send + '_ {
        async move {
            let mut buf = [0u8; 8];
...
mod test {
    ...
    // TODO: Test bytes length usize conversion overflow
    // TODO: Test bytes length aligned usize conversion overflow
