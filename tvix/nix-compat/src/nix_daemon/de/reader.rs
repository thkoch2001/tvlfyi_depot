...
impl NixReaderBuilder {
    ...
    #[must_use]
    pub const fn set_reserved_buf_size(mut self, size: usize) -> Self {
        self.reserved_buf_size = size;
        self
    }

    #[must_use]
    pub const fn set_max_buf_size(mut self, size: usize) -> Self {
        self.max_buf_size = size;
        self
    }

    #[must_use]
    pub const fn set_version(mut self, version: ProtocolVersion) -> Self {
