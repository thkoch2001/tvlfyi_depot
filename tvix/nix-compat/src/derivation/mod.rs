...
impl Derivation {
    ...
    /// outputs.
    ///
    /// TODO: this should really be a function from a [PreDerivation] to a [Derivation].
    /// If this is done with the TODO on [Output] too, we'll completely statically check
    /// whether a we have yet to calculate the paths or everything is properly "baked".
    /// This is good.
