...
impl Derivation {
    ...
    fn serialize_with_replacements(
        ...
        use write::{COMMA, PAREN_CLOSE, write_arguments, write_builder, write_char, write_environment, write_input_derivations, write_input_sources, write_outputs, write_system};
    ...
    #[must_use] pub fn to_aterm_bytes(&self) -> Vec<u8> {
