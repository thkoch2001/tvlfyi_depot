...
impl Derivation {
    ...
    /// the `name` with a `.drv` suffix as name, all self.input_sources and
    /// keys of self.input_derivations as references,
    /// and the ATerm string of the Derivation as content.
