...
- not yet implemented, but not blocked by other prerequisites:
  ...
  - `primdrv` awaiting mechanism for primitive "builtin derivations" (e.g. `fetchurl`)
...
| elemAt                        | false  |       |       |         |
| false                         | true   |       |       |         |
| fetchGit                      | true   |       |       | primdrv |
| fetchMercurial                | true   |       |       | primdrv |
| fetchTarball                  | true   |       |       | primdrv |
| fetchurl                      | false  |       |       | primdrv |
| filter                        | false  |       |       |         |
| filterSource                  | false  |       |       | primdrv |
