        ...
        while let Some(frame) = self.frames.pop() {
            ...
            match frame {
                Frame::CallFrame { call_frame, span } => {
                    ...
                    if self.execute_bytecode(span, frame_id, call_frame)? {
                ...
                Frame::Generator {
                    ...
                    if self.run_generator(span, state, generator)? {
...
impl<'o> VM<'o> {
    ...
    fn tail_call_value(
        ...
        match callable {
            ...
            v => Err(
                todo!("can't call {}", v), /*parent.error(ErrorKind::NotCallable(callable.type_of())) */
            ),
        }
    }
