...
use self::generators::GeneratorResponse;
...
impl<'o> VM<'o> {
    ...
    fn execute(mut self) -> EvalResult<RuntimeResult> {
        let mut catchable_error_occured = false;
        ...
        while let Some(frame) = self.frames.pop() {
            ...
            match frame {
                ...
                Frame::Generator {
                    ...
                    let initial_msg = if catchable_error_occured {
                        catchable_error_occured = false;
