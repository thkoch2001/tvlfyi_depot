...
use crate::{
    ...
    upvalues::Upvalues,
    value::{
        Builtin, BuiltinResult, Closure, CoercionKind, Lambda, NixAttrs, NixList, SharedThunkSet,
        Thunk, Value,
    },
    vm::generators::GenCo,
...
use generators::{call_functor, neo_resolve_with, pin_generator, Generator, GeneratorState};
        ...
        match callable {
            ...
            val @ Value::Attrs(_) => {
                self.frames.push(Frame::Generator {
                    ...
                    generator: Gen::new(|co| pin_generator(call_functor(co, val))),
                });
