...
/// in a context. This is necessary for deeply forcing cyclic
/// non-diverging data structures like `rec { f = [ f ]; }`.  This
/// is separate from the ThunkRepr::Blackhole mechanism, which
