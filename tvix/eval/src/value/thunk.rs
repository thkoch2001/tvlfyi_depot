        ...
        loop {
            ...
            match inner {
                ...
                ThunkRepr::Suspended {
                    ...
                    // TODO(amjoseph): use #[tailcall::mutual] here.  Note
                    // that this is not a tail-recursive call; however I have
                    // ideas on how it can be turned into one if we can call
                    // into the VM directly without using the generator
                    // mechanism.
                    let value =
