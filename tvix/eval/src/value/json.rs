...
impl Value {
    ...
    pub async fn into_contextful_json(
        ...
        let value = match self_forced {
            ...
            val @
(Self::Closure(_) | Self::Thunk(_) | Self::Builtin(_) | Self::AttrNotFound |
Self::Blueprint(_) | Self::DeferredUpvalue(_) | Self::UnresolvedPath(_) |
Self::Json(..) | Self::FinaliseRequest(_)) => {
