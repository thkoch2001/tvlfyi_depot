...
pub trait Syntax {
    ...
    type Inherit: Inherit<Syntax = Self>;
    type Attr: Attr<Syntax = Self>;
    type AttrPath: AttrPath<Syntax = Self>;
    type AttrPathValue: AttrPathValue<Syntax = Self>;
    type AttrSet: AttrSet<Syntax = Self> + HasEntry<Syntax = Self>;
    type LetIn: LetIn<Syntax = Self> + HasEntry<Syntax = Self>;
    type LegacyLet: LegacyLet<Syntax = Self> + HasEntry<Syntax = Self>;
...
pub trait AttrPathValue: Clone + ToSpan + FromCst<rnix::ast::AttrpathValue> {
    type Syntax: self::Syntax;
    fn path(&self) -> <Self::Syntax as self::Syntax>::AttrPath;
    fn value(&self) -> <Self::Syntax as self::Syntax>::Expr;
    fn new(
        span: Span,
        path: <Self::Syntax as self::Syntax>::AttrPath,
        value: <Self::Syntax as self::Syntax>::Expr,
    ) -> Self;
}
...
pub trait Inherit: Clone + ToSpan + FromCst<rnix::ast::Inherit> {
    type Syntax: self::Syntax;
    fn namespace(&self) -> Option<<Self::Syntax as self::Syntax>::Expr>;
    fn attrs(&self) -> Vec<<Self::Syntax as self::Syntax>::Attr>;
    fn new(
        namespace: Option<<Self::Syntax as self::Syntax>::Expr>,
        attrs: Vec<<Self::Syntax as self::Syntax>::Attr>,
        span: Span,
    ) -> Self;
}
