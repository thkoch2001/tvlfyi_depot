...
impl AttrPath<SyntaxImpl> for AttrPathImpl {
    fn first(&mut self) -> Option<&<SyntaxImpl as Syntax>::Attr> {
        self.components.last()
    }
    fn take_first(&mut self) -> Option<<SyntaxImpl as Syntax>::Attr> {
        self.components.pop()
    }
}
...
impl Inherit<SyntaxImpl> for InheritImpl {
    ...
    fn attrs(&self) -> Vec<<SyntaxImpl as Syntax>::Attr> {
        self.attrs.clone()
    }
    fn new(
        namespace: Option<<SyntaxImpl as Syntax>::Expr>,
        attrs: Vec<<SyntaxImpl as Syntax>::Attr>,
        span: Span,
    ) -> Self {
        InheritImpl {
            namespace,
...
impl Attr<SyntaxImpl> for AttrImpl {
    fn attr(&self) -> &StaticOrDynamic<SmolStr, <SyntaxImpl as Syntax>::Expr> {
        &self.attr
    }
    fn into_attr(self) -> StaticOrDynamic<SmolStr, <SyntaxImpl as Syntax>::Expr> {
        self.attr
    }
    ...
    fn from_dynamic(expr: <SyntaxImpl as Syntax>::Expr, span: Span) -> Self {
        AttrImpl {
            span,
