...
use super::syn::{
    Attr, AttrPath, AttrPathValue, AttrSet, Expr, FromCst, HasEntry, Ident, Inherit, LetIn,
    StaticOrDynamic,
};
    ...
    Syntax: syn::Syntax,
{
    ...
    fn merge(
        ...
        match self {
            ...
            // and recurse.
            Binding::Plain { expr } => match expr.as_cst() {
                ast::Expr::AttrSet(existing) => {
                    *self = Binding::from_cst(c, &existing);
            ...
            Binding::Set {
                ...
                if let ast::Expr::AttrSet(new) = value.to_cst() {
                    inherits.extend(
...
impl<Syntax> FromCst<&rnix::ast::AttrSet> for Binding<Syntax>
where
    Syntax: syn::Syntax,
{
    fn from_cst(c: &Compiler, node: &ast::AttrSet) -> Self {
        Binding::Set {
    ...
    Syntax: syn::Syntax,
{
    ...
    fn try_merge(
        ...
        if remaining_path.first().is_none() && !matches!(value.as_cst(), ast::Expr::AttrSet(_)) {
            return false;
        }
...
impl Compiler<'_, '_> {
    ...
    where
        Syntax: syn::Syntax,
        Syntax::AttrSet: HasEntry<Syntax = Syntax>,
    {
