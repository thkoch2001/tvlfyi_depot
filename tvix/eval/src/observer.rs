...
use crate::generators::GeneratorMessage;
...
pub trait RuntimeObserver {
    ...
    fn observe_generator_request(&mut self, _msg: &GeneratorMessage) {}
...
impl<W: Write> RuntimeObserver for TracingObserver<W> {
    ...
    fn observe_generator_request(&mut self, msg: &GeneratorMessage) {
