...
mod pure_builtins {
    ...
    async fn builtin_appendContext(
        ...
        // It cannot remove an context element, neither replace a piece of its contents.
        //
        ...
        // to inexistent derivations or output paths or output names.
        //
        ...
        // via `builtins.storeDir`.
        // In addition, if writing to the store is possible (evaluator not in read-only mode), Nix
        // will realize some paths and ensure they are present in the store.
        //
