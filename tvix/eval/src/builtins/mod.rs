...
pub fn global_builtins(source: SourceCode) -> GlobalsMap {
    Box::new(
        move |globals: &std::rc::Weak<HashMap<&'static str, Value>>| {
            ...
            #[cfg(feature = "impure")]
            {
                ...
                map.insert("import".into(), import);
            };

            let builtins = NixAttrs::from_map(map);
