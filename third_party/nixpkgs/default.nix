...
let
  ...
  # Tracking nixos-unstable as of 2021-08-18.
  unstableHashes = {
    commit = "253aecf69ed7595aaefabde779aa6449195bebb7";
    sha256 = "14szn1k345jfm47k6vcgbxprmw1v16n7mvyhcdl7jbjmcggjh4z7";
  };

  # Tracking nixos-21.05 as of 2021-08-18.
  stableHashes = {
    commit = "97c5d0cbe76901da0135b05cdbdfc5b068a7942c";
