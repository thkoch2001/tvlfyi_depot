...
class StoreTest : public ::testing::Test {
 public:
  ...
  absl::StatusOr<std::filesystem::path> OpenTempDir(std::filesystem::path parent = std::filesystem::temp_directory_path()) {
    while (1) {
      ...
      std::error_code ec;
      std::filesystem::path candidate = parent / absl::StrCat("nixtest-", absl::WebSafeBase64Escape(randBytes));
      if (std::filesystem::create_directory(candidate, ec)) {
        cleanup_funcs_.push_back([candidate]() {
