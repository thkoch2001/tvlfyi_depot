...
depot.nix.buildLisp.library
  {
    name = "mime4cl";
    deps = [ depot.third_party.lisp.sclf depot.third_party.lisp.npg depot.third_party.lisp.trivial-gray-streams ];
    srcs = [ ./package.lisp ./endec.lisp ./streams.lisp ./mime.lisp ./address.lisp ];
    tests = {
      name = "mime4cl-tests";
      srcs = [
        ./test/rt.lisp
