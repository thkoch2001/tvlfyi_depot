    ...
    depot.nix.buildLisp.library
      {
        ...
        srcs = map ( f: src + ( "/" + f ) ) [ "packages.lisp" "specials.lisp" "util.lisp" ];
      };
  cl-unicode-build =
    depot.nix.buildLisp.program
      {
        ...
        deps =
          ...
          [ cl-unicode-base flexi-streams { ecl = bundled "asdf"; default = bundled "uiop"; } ];
        srcs =
          ( map ( f: src + ( "/build/" + f ) ) [ "util.lisp" "char-info.lisp" "read.lisp" ] )
            ++ [
              (
                runCommand
                  "dump.lisp"
              ...
              (
                writeText
                  "export-create-source-files.lisp"
                  ''
