    ...
    with super.haskell.lib; {
      ...
      nix-diff = overrideSrc hsSuper.nix-diff {
        src = builtins.fetchTarball {
          ...
          url =
            "https://github.com/Profpatsch/nix-diff/archive/6234936b26cd144d321039a44cf1791dcfaee026.tar.gz";
          sha256 = "1i3ahh8jmiayf29i1xrl2n1dkldgdmrllmccxi4yx6hbcd0r2b1l";
        };
      };
    };
in { haskellPackages = super.haskellPackages.override { inherit overrides; }; }
