...
rec
  ...
  cfg-if =
    buildRustCrate
      { pname = "cfg-if"; version = "1.0.0"; sha256 = "1fzidq152hnxhg4lj6r2gv4jpnn8yivp27z6q6xy7w6v0dp6bai9"; };
  cc =
    buildRustCrate
      { pname = "cc"; version = "1.0.66"; sha256 = "12q71z6ck8wlqrwgi25x3lrryyks9djymswn9b1c6qq0i01jpc1p"; };
  ascii =
    buildRustCrate
      {
        pname = "ascii";
  ...
  bitflags =
    buildRustCrate
      { pname = "bitflags"; version = "1.2.1"; sha256 = "0b77awhpn7yaqjjibm69ginfn996azx5vkzfjj39g3wbsqs7mkxg"; };
  inotify-sys =
    buildRustCrate
      {
        pname = "inotify-sys";
  ...
  bufstream =
    buildRustCrate
      { pname = "bufstream"; version = "0.1.4"; sha256 = "10rqm7jly5jjx7wcc19q6q4m2zsrw3l2v3m1054wnbwvdh42xxf1"; };
  autocfg =
    buildRustCrate
      {
        pname = "autocfg";
  ...
  lazy_static =
    buildRustCrate
      { pname = "lazy_static"; version = "1.4.0"; sha256 = "13h6sdghdcy7vcqsm2gasfw3qg7ssa0fl3sw7lq6pdkbk52wbyfr"; };
  imap =
    buildRustCrate
      {
        pname = "imap";
  ...
  ryu =
    buildRustCrate
      { pname = "ryu"; version = "1.0.5"; sha256 = "060y2ln1csix593ingwxr2y3wl236ls0ly1ffkv39h5im7xydhrc"; };
  itoa =
    buildRustCrate
      { pname = "itoa"; version = "0.4.7"; sha256 = "0079jlkcmcaw37wljrvb6r3dqq15nfahkqnl5npvlpdvkg31k11x"; };
  serde_json =
    buildRustCrate
      {
        pname = "serde_json";
    ...
    buildRustCrate
      {
        ...
        dependencies = [ matches unicode-normalization unicode-bidi ];
      };
  url =
    buildRustCrate
      {
    ...
    buildRustCrate
      {
        ...
        dependencies = [ bitflags libc libgit2-sys log url ];
      };
}
