...

{
  ...
  systemd.services.journaldriver = {
    serviceConfig = {
      ...
      ExecStart = lib.mkForce "${pkgs.bash}/bin/bash -c 'env GOOGLE_APPLICATION_CREDENTIALS=\"$CREDENTIALS_DIRECTORY/journaldriver.json\" ${depot.ops.journaldriver}/bin/journaldriver'";
    };
  };
}
