...
func buildTriggerFromPatchsetCreated() (*buildTrigger, error) {
	...
	flag.Bool("topic", false, "flag to ignore") // see cl/4001
	ignoreFlags([]string{"kind", "change", "uploader", "uploader-username", "change-owner-username"})
...
func buildTriggerFromChangeMerged() *buildTrigger {
	...
	flag.Bool("topic", false, "flag to ignore") // see cl/4001
	ignoreFlags([]string{"change", "change-url", "submitter", "submitter-username", "commit", "change-owner-username"})
