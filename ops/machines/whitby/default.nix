...
in {
  ...
  # configuration
  systemd.services.keycloak.serviceConfig.ExecStart = lib.mkForce
    "${config.services.keycloak.package}/bin/standalone.sh --add-exports=java.naming/com.sun.jndi.ldap=ALL-UNNAMED";
