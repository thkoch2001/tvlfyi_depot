...
#
# It’s similar to `runCommand`, but instead of
# concatenating bash scripts left and right,
# it actually *uses* the features of `derivation`,
# passing things to `args` and making it possible to
...
#
# Similar to `writeExecline`, the passed script is
