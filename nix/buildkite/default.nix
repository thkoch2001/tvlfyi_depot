...
in rec {
  ...
  mkPipeline = {
    ...
    # A list of plain Buildkite step structures to run along the build
    # for all drvTargets, but before proceeding with any post-build
    # actions such as status reporting.
    #
