...
in rec {
  ...
  mkPipeline = {
    ...
    # List of derivation targets (in most cases just the output of
    # readTree.gather) that should be built in Buildkite.
    #
    ...
    # A list of plain Buildkite step structures to run after the
    # builds for all drvTargets, but before proceeding with any
