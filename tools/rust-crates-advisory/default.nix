    ...
    depot.nix.writers.rustSimple
      {
        ...
        dependencies = [ depot.third_party.rust-crates.toml depot.third_party.rust-crates.semver ];
      }
  ...
  check-all-our-crates =
    depot.nix.runExecline
              ...
              map
                (
                  ...
                  depot.nix.netstring.fromString
                    ( depot.nix.netstring.fromString crate.crateName + depot.nix.netstring.fromString crate.version )
                )
                our-crates
            );
      }
      [
        ...
        [ "if" [ depot.tools.eprintf "Error: Found active advisories!" ] "exit" "1" ]
        "importas"
        "out"
        "out"
        bins.s6-touch
...
depot.nix.readTree.drvTargets
  {
    check-all-our-crates = depot.nix.drvSeqL [ test-parsing-all-security-advisories ] check-all-our-crates;
    inherit check-crate-advisory;
  }
