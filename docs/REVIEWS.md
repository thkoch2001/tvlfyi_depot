...
- To "mark as read" a CL you *must* vote on it or make a comment.
  This is the only way to remove you from the attention set, and to
  remove the CL from your "your turn" list.  There is nothing
  equivalent to the checkmark button in the Github notifications
  list.
