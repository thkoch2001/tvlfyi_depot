...
both sides:
 ...
 - Someone needs to relay potential comments from Gerrit to you, you won't get
   emails from Gerrit.
 - Updating new revisions needs to be done by the person sending it to Gerrit on
   your behalf.
 - You can't change the author of a CL later, if you decide to create an account
   later on. The CL needs to be abandoned and re-created.
